<template>
  <CommonModal v-model:opened="modalDisplayed" :initial-focus="checkbox" :closable="false">
    ...
    <CommonCheckboxWithText ref="checkbox" v-model="warningChecked" class="mt-3">
      I agree to the
      <a href="https://www.zeeve.io/terms-and-conditions/" target="_blank" class="checkbox-link">Terms of Service</a>
      and
      <a href="https://www.zeeve.io/privacy-policy/" target="_blank" class="checkbox-link">Privacy Policy</a>
